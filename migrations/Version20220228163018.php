 ...
 */
final class Version20220228163018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase ADD numero VARCHAR(255) NOT NULL');
    }
